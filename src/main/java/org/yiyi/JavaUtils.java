...
public final class JavaUtils {
    ...
    @NotNull
    public static Optional<PsiClass> findClazz(@NotNull Project project, @NotNull String fullQualifiedClazzName) {
        return Optional.ofNullable(JavaPsiFacade.getInstance(project).findClass(fullQualifiedClazzName, GlobalSearchScope.allScope(project)));
    }
